...
export function CandidatesView() {
  ...
  return (
    <div className="flex flex-col h-full space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">👥 Kandidaten Pool</h1>
        <p className="text-muted-foreground mt-2">
          Verwalte extrahierte Lebensläufe, Identitätsprüfungen und KI-generierte Dokumente direkt hier im Dashboard.
        </p>
      </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-[50vh] text-center space-y-5 px-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2 max-w-md">Dein Bewerber-Pool ist noch leer. Wechsle zurück zum "Lebensläufe Extrahieren"-Tab, um erste Ergebnisse zu generieren.</p>
              </div>
            </div>
          ) : (
